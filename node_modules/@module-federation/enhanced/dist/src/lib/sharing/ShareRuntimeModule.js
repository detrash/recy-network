...
const { compareModulesByIdentifier, compareStrings } = require((0, normalize_webpack_path_1.normalizeWebpackPath)('webpack/lib/util/comparators'));
class ShareRuntimeModule extends RuntimeModule {
    ...
    generate() {
        ...
        const { runtimeTemplate, codeGenerationResults, outputOptions: { uniqueName, ignoreBrowserWarnings }, } = compilation;
        ...
        for (const chunk of this.chunk?.getAllReferencedChunks() || []) {
            ...
            const modules = chunkGraph.getOrderedChunkModulesIterableBySourceType(chunk, 'share-init', 
            // @ts-ignore
